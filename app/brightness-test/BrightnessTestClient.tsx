    ...
    <>
      ...
      {showFullscreen && (
        <div
          ...
          style={{
            backgroundColor: `rgb(${brightnessLevel * 2.55}, ${brightnessLevel * 2.55}, ${brightnessLevel * 2.55})`
          }}
          onClick={exitFullscreen}
        >
          <div className="bg-black bg-opacity-70 text-white p-6 rounded-lg max-w-md text-center">
            <p className="text-2xl font-bold mb-4">{brightnessLevel}% Brightness</p>
            <p className="mb-4">{brightnessDescriptions[brightnessLevel].desc}</p>
            <p className="text-sm mb-4">Look for hot spots, dim areas, and uniformity issues</p>
            <button
              onClick={exitFullscreen}
